...
public class QueryExpressionType  implements java.io.Serializable, org.apache.axis.encoding.AnyContentType, org.apache.axis.encoding.MixedContentType {
    ...
    /**
     * Gets the queryLanguage value for this QueryExpressionType.
     * 
    ...
    /**
     * Sets the queryLanguage value for this QueryExpressionType.
     * 
     * @param queryLanguage
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:oasis:names:tc:ebxml-regrep:xsd:rim:3.0", "QueryExpressionType"));
