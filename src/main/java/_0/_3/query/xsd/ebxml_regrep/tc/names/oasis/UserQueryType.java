...
public class UserQueryType  extends _0._3.query.xsd.ebxml_regrep.tc.names.oasis.PersonQueryType  implements java.io.Serializable {
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof UserQueryType)) return false;
        UserQueryType other = (UserQueryType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(UserQueryType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:oasis:names:tc:ebxml-regrep:xsd:query:3.0", "UserQueryType"));
    }
