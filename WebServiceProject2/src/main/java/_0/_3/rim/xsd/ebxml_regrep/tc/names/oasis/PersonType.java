 ...
 */
public class PersonType  extends _0._3.rim.xsd.ebxml_regrep.tc.names.oasis.RegistryObjectType  implements java.io.Serializable {
    private _0._3.rim.xsd.ebxml_regrep.tc.names.oasis.PostalAddressType[] address;

    private _0._3.rim.xsd.ebxml_regrep.tc.names.oasis.PersonNameType personName;
    ...
    /**
     * Gets the personName value for this PersonType.
     * 
     * @return personName
     */
    public _0._3.rim.xsd.ebxml_regrep.tc.names.oasis.PersonNameType getPersonName() {
        return personName;
    }


    /**
     * Sets the personName value for this PersonType.
     * 
     * @param personName
     */
    public void setPersonName(_0._3.rim.xsd.ebxml_regrep.tc.names.oasis.PersonNameType personName) {
        this.personName = personName;
    }


    /**
     * Gets the telephoneNumber value for this PersonType.
     * 
    ...
    /**
     * Sets the telephoneNumber value for this PersonType.
     * 
    ...
    /**
     * Gets the emailAddress value for this PersonType.
     * 
     * @return emailAddress
     */
    ...
    /**
     * Sets the emailAddress value for this PersonType.
     * 
     * @param emailAddress
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:oasis:names:tc:ebxml-regrep:xsd:rim:3.0", "PersonType"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:oasis:names:tc:ebxml-regrep:xsd:rim:3.0", "PersonName"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:oasis:names:tc:ebxml-regrep:xsd:rim:3.0", "PersonNameType"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
