...
public class SubmitObjectsRequest  extends _0._3.rs.xsd.ebxml_regrep.tc.names.oasis.RegistryRequestType  implements java.io.Serializable {
    ...
    /**
     * Gets the registryObjectList value for this SubmitObjectsRequest.
     * 
    ...
    /**
     * Sets the registryObjectList value for this SubmitObjectsRequest.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof SubmitObjectsRequest)) return false;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(SubmitObjectsRequest.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:oasis:names:tc:ebxml-regrep:xsd:lcm:3.0", ">SubmitObjectsRequest"));
